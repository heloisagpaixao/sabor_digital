...
Mesmo que você tenha perdido a explicação ao vivo, seguindo estes passos você entenderá não apenas _como_ fazer, mas _por que_ cada peça se encaixa nesse quebra-cabeça.
...
const doc = {
  info: {
    ...
    description:
      "Documentação automática da API Sabor Digital utilizando Swagger Autogen",
    version: "1.0.0",
  },
  host: "localhost:3000",
  schemes: ["http"],
...
_Se der certo, você verá a mensagem de sucesso e um arquivo gigante chamado `swagger_output.json` vai aparecer na raiz do seu projeto._
...
_Parabéns! Sua API agora tem um nível de documentação profissional padrão de mercado!_
